...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
            <div class="main-box">
                <div class="col-lg-8"> <h3>Skills</h3></div>
						  ...
						  <table class="table table-bordered">
							<tbody>
							  <tr>
								...
								<td>Skill 4</td>
								<td>Skill 5</td>
                                <td><a class="btn btn-default" href="view-more.php">View more</a></td>
							  </tr>
							  <tr>
								<th>Grade 2</th>
								<td>Skill 1</td>
		...
		<!--footer section start-->
			<footer>
			   <p>&copy 2016 Skillizen Admin Panel. All Rights Reserved |</p>
			</footer>
        <!--footer section end-->
	</section>
